...
;       If it reaches this point, the ball is colliding with the left paddle    
	...
	proc move_paddles						;process the movement of the paddles
...
;			when the paddle is being controlled by the AI
    ...
    proc reset_ball_position						;restart ball position to the original position values
...
;       draw the points of the right player
    ...
    proc update_text_player_one_points
        ...
        ret
    endp update_text_player_one_points 
    ...
    proc update_text_player_two_points
        ...
        ret
    endp update_text_player_two_points 
...
;           check which key was pressed     
    ...
    proc CONCLUDE_EXIT_GAME        ;go back to text mode and terminate
